...
<div class="dashboard-wrapper d-flex">
    <!-- Student Sidebar (Adjust links as per your student dashboard design) -->
                        ...
                        <div class="card border-0 shadow-sm rounded-4 h-100 bg-white overflow-hidden">
                            ...
                            <div class="card-body p-4 d-flex flex-column justify-content-between">
                                ...
                                <div class="d-flex justify-content-between align-items-center mt-3 pt-3 border-top">
                                    <span class="text-muted small"><i class="fa-solid fa-calendar-days me-1"></i> Enrolled: <?php echo date('M d, Y', strtotime($course['enrolled_at'])); ?></span>
                                    <a href="../course-details.php?id=<?php echo $course['id']; ?>" class="btn btn-outline-primary btn-sm fw-bold px-3">Continue</a>
                                </div>
                            </div>
                        </div>
                    </div>
